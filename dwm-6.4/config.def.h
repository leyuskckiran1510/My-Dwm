...
static const char *fonts[]          = { "MesloLGM Nerd Font:style=Regular:size=13","monospace:size=10"};
static const char dmenufont[]       = "MesloLGM Nerd Font:style=Regular:size=13";
